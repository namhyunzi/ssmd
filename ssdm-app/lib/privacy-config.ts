...
export const PRIVACY_CONFIG = {
  baseUrl: process.env.NEXT_PUBLIC_BASE_URL || 'https://ssmd-smoky.vercel.app',
  mallId: process.env.MALL_ID || 'demo_mall',
  apiKey: process.env.PRIVACY_SYSTEM_API_KEY || 'api_demo_1234567890abcdef',
  sessionTypes: {
    paper: { name: '종이송장 (관리자용)', ttl: 3600, extensible: false },
    qr: { name: 'QR송장 (배송기사용)', ttl: 43200, extensible: true, maxExtensions: 3 }
  }
}
